...
const hotItems = [
  {
    id: "gi-bomber",
    name: "GENERAL IDEA 시그니처 봄버",
    price: 239000,
    img: "https://images.unsplash.com/photo-1548883354-aa561b2a26c7?auto=format&fit=crop&w=1200&q=80",
    badges: ["BEST"],
  },
  {
    id: "gi-denim",
    name: "GENERAL IDEA 와이드 데님",
    price: 129000,
...
export default function BrandGeneralIdeaDetail() {
  const itemCards = useMemo(
    () =>
      hotItems.map((p) => (
        <div className="gi-card" key={p.id}>
  ...
  return (
    <div className="brand-gi">
      ...
      <section className="gi-section">
        ...
        <div className="gi-grid">{itemCards}</div>
      </section>

      {/* 신규 회원 혜택 */}
      <section className="gi-benefit">
        <div className="inner">
      ...
      {/* LOOKBOOK */}
      <section className="gi-section">
        <div className="gi-head"><h2>LOOKBOOK</h2></div>
      ...
      {/* 매장/안내 */}
      <section className="gi-section">
        <div className="gi-head"><h2>GENERAL IDEA 오프라인</h2></div>
        <div className="gi-store">
